...
\begin{document}
\tlatex
\@x{}\moduleLeftDash\@xx{ {\MODULE} LinearizableQueue}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Sequences}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANTS} Val ,\, Thread ,\, none}%
\@x{ {\VARIABLES} op ,\, arg ,\, rval ,\, up ,\, done ,\, d}%
\@pvspace{8.0pt}%
\@x{ {\ASSUME} none \.{\notin} Val}%
\@pvspace{8.0pt}%
\@x{ EnqStart ( Ti ) \.{\defeq} \.{\land} done [ Ti ]}%
 \@x{\@s{77.45} \.{\land} op \.{'} \.{=} [ op {\EXCEPT} {\bang} [ Ti ]
 \.{=}\@w{enq} ]}%
 \@x{\@s{77.45} \.{\land} \E\, x \.{\in} Val \.{:} arg \.{'} \.{=} [ arg
 {\EXCEPT} {\bang} [ Ti ] \.{=} x ]}%
 \@x{\@s{77.45} \.{\land} rval \.{'} \.{=} [ rval {\EXCEPT} {\bang} [ Ti ]
 \.{=} none ]}%
 \@x{\@s{77.45} \.{\land} up \.{'} \.{=} [ up {\EXCEPT} {\bang} [ Ti ] \.{=}
 {\FALSE} ]}%
 \@x{\@s{77.45} \.{\land} done \.{'} \.{=} [ done {\EXCEPT} {\bang} [ Ti ]
 \.{=} {\FALSE} ]}%
\@x{\@s{77.45} \.{\land} {\UNCHANGED} d}%
\@pvspace{8.0pt}%
 \@x{ EnqTakesEffect ( Ti ) \.{\defeq}\@s{4.1} \.{\land} op [ Ti ]
 \.{=}\@w{enq}}%
\@x{\@s{109.67} \.{\land} {\lnot} done [ Ti ]}%
\@x{\@s{109.67} \.{\land} {\lnot} up [ Ti ]}%
 \@x{\@s{109.67} \.{\land} up \.{'} \.{=} [ up {\EXCEPT} {\bang} [ Ti ] \.{=}
 {\TRUE} ]}%
\@x{\@s{109.67} \.{\land} d \.{'} \.{=} Append ( d ,\, arg [ Ti ] )}%
 \@x{\@s{109.67} \.{\land} {\UNCHANGED} {\langle} op ,\, arg ,\, rval ,\, done
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ EnqDone ( Ti ) \.{\defeq} \.{\land} op [ Ti ] \.{=}\@w{enq}}%
\@x{\@s{78.54} \.{\land} up [ Ti ]}%
\@x{\@s{78.54} \.{\land} {\lnot} done [ Ti ]}%
 \@x{\@s{78.54} \.{\land} done \.{'} \.{=} [ done {\EXCEPT} {\bang} [ Ti ]
 \.{=} {\TRUE} ]}%
 \@x{\@s{78.54} \.{\land} {\UNCHANGED} {\langle} op ,\, arg ,\, rval ,\, up
 ,\, d {\rangle}}%
\@pvspace{8.0pt}%
\@x{ DeqStart ( Ti ) \.{\defeq} \.{\land} done [ Ti ]}%
 \@x{\@s{76.68} \.{\land} op \.{'} \.{=} [ op {\EXCEPT} {\bang} [ Ti ]
 \.{=}\@w{deq} ]}%
 \@x{\@s{76.68} \.{\land} arg \.{'} \.{=} [ arg {\EXCEPT} {\bang} [ Ti ] \.{=}
 none ]}%
 \@x{\@s{76.68} \.{\land} rval \.{'} \.{=} [ rval {\EXCEPT} {\bang} [ Ti ]
 \.{=} none ]}%
 \@x{\@s{76.68} \.{\land} up \.{'} \.{=} [ up {\EXCEPT} {\bang} [ Ti ] \.{=}
 {\FALSE} ]}%
 \@x{\@s{76.68} \.{\land} done \.{'} \.{=} [ done {\EXCEPT} {\bang} [ Ti ]
 \.{=} {\FALSE} ]}%
\@x{\@s{76.68} \.{\land} {\UNCHANGED} d}%
\@pvspace{8.0pt}%
\@x{ DeqTakesEffect ( Ti ) \.{\defeq} \.{\land} op [ Ti ] \.{=}\@w{deq}}%
\@x{\@s{104.81} \.{\land} d \.{\neq} {\langle} {\rangle}}%
\@x{\@s{104.81} \.{\land} {\lnot} up [ Ti ]}%
\@x{\@s{104.81} \.{\land} {\lnot} done [ Ti ]}%
 \@x{\@s{104.81} \.{\land} rval \.{'} \.{=} [ rval {\EXCEPT} {\bang} [ Ti ]
 \.{=} Head ( d ) ]}%
 \@x{\@s{104.81} \.{\land} up \.{'} \.{=} [ up {\EXCEPT} {\bang} [ Ti ] \.{=}
 {\TRUE} ]}%
\@x{\@s{104.81} \.{\land} d \.{'} \.{=} Tail ( d )}%
 \@x{\@s{104.81} \.{\land} {\UNCHANGED} {\langle} op ,\, arg ,\, done
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ DeqDone ( Ti ) \.{\defeq} \.{\land} op [ Ti ] \.{=}\@w{deq}}%
\@x{\@s{77.78} \.{\land} up [ Ti ]}%
\@x{\@s{77.78} \.{\land} {\lnot} done [ Ti ]}%
 \@x{\@s{77.78} \.{\land} done \.{'} \.{=} [ done {\EXCEPT} {\bang} [ Ti ]
 \.{=} {\TRUE} ]}%
 \@x{\@s{77.78} \.{\land} {\UNCHANGED} {\langle} op ,\, arg ,\, rval ,\, up
 ,\, d {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Init\@s{4.12} \.{\defeq} \.{\land} op \.{=} [ Ti \.{\in} Thread
 \.{\mapsto}\@w{start} ]}%
\@x{\@s{39.83} \.{\land} arg \.{=} [ Ti \.{\in} Thread \.{\mapsto} none ]}%
\@x{\@s{39.83} \.{\land} rval \.{=} [ Ti \.{\in} Thread \.{\mapsto} none ]}%
\@x{\@s{39.83} \.{\land} up \.{=} [ Ti \.{\in} Thread \.{\mapsto} {\TRUE} ]}%
 \@x{\@s{39.83} \.{\land} done \.{=} [ Ti \.{\in} Thread \.{\mapsto} {\TRUE}
 ]}%
\@x{\@s{39.83} \.{\land} d \.{=} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \E\, Ti \.{\in} Thread \.{:}}%
\@x{\@s{39.83} \.{\lor} EnqStart ( Ti )}%
\@x{\@s{39.83} \.{\lor} EnqTakesEffect ( Ti )}%
\@x{\@s{39.83} \.{\lor} EnqDone ( Ti )}%
\@x{\@s{39.83} \.{\lor} DeqStart ( Ti )}%
\@x{\@s{39.83} \.{\lor} DeqTakesEffect ( Ti )}%
\@x{\@s{39.83} \.{\lor} DeqDone ( Ti )}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle} op
 ,\, arg ,\, rval ,\, up ,\, done ,\, d {\rangle}}}%
\@x{}\bottombar\@xx{}%
\end{document}
