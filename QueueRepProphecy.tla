...
*)
\* BEGIN TRANSLATION
\* Procedure variable i of procedure Enq at line 28 col 11 changed to i_
\* Procedure variable x of procedure Deq at line 39 col 14 changed to x_
CONSTANT defaultInitValue
VARIABLES pc, rep, p, stack, x, i_, preINC, i, x_, range, rInd, rVal

vars == << pc, rep, p, stack, x, i_, preINC, i, x_, range, rInd, rVal >>
...
E2(self) == /\ pc[self] = "E2"
            ...
            /\ UNCHANGED << p, stack, x, i_, preINC, i, x_, range, rInd, rVal >>
...
E3(self) == /\ pc[self] = "E3"
            ...
            /\ UNCHANGED << rep, p, i, x_, range, rInd, rVal >>

Enq(self) == E1(self) \/ E2(self) \/ E3(self)

D1(self) == /\ pc[self] = "D1"
            /\ pc' = [pc EXCEPT ![self] = "D2"]
            /\ UNCHANGED << rep, p, stack, x, i_, preINC, i, x_, range, rInd, 
                            rVal >>

D2(self) == /\ pc[self] = "D2"
            /\ rInd' = [rInd EXCEPT ![self] = rep.back]
            /\ pc' = [pc EXCEPT ![self] = "D3"]
            /\ UNCHANGED << rep, p, stack, x, i_, preINC, i, x_, range, rVal >>

D3(self) == /\ pc[self] = "D3"
            /\ range' = [range EXCEPT ![self] = rInd[self]-1]
            /\ pc' = [pc EXCEPT ![self] = "D4"]
            /\ UNCHANGED << rep, p, stack, x, i_, preINC, i, x_, rInd, rVal >>

D4(self) == /\ pc[self] = "D4"
            /\ i' = [i EXCEPT ![self] = 1]
            /\ pc' = [pc EXCEPT ![self] = "D5"]
            /\ UNCHANGED << rep, p, stack, x, i_, preINC, x_, range, rInd, 
                            rVal >>
...
D6(self) == /\ pc[self] = "D6"
            ...
            /\ UNCHANGED << p, stack, x, i_, preINC, i, x_, range, rInd >>
...
D7(self) == /\ pc[self] = "D7"
            ...
            /\ UNCHANGED << rep, p, stack, x, i_, preINC, i, range, rInd, rVal >>
