...
\begin{document}
\tlatex
\@x{}\moduleLeftDash\@xx{ {\MODULE} LinQueue}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
...
\@x{ {\EXTENDS} Sequences}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANTS} item ,\, producer ,\, consumer}%
\@pvspace{8.0pt}%
 \@x{ null \.{\defeq} {\CHOOSE} null \.{:} null \.{\notin} item \.{\cup}
 \{\@w{ok} \}}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} LinQueue {\p@lbrace}}%
\@pvspace{8.0pt}%
\@x{ {\p@variable} q \.{=} {\langle} {\rangle} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@process} {\p@lparen} prod \.{\in} producer {\p@rparen}}%
 \@x{ {\p@variables} x \.{=} null ,\, rval \.{=} null {\p@semicolon}
 {\p@lbrace}}%
 \@x{ E1\@s{.5}\textrm{:}\@s{3} {\p@with} {\p@lparen} arg \.{\in} item
 {\p@rparen} {\p@lbrace}}%
\@y{\@s{0}%
 invocation starts
}%
\@xx{}%
\@x{\@s{35.66} x \.{:=} arg}%
\@x{\@s{19.26} {\p@rbrace} {\p@semicolon}}%
\@x{ E2\@s{.5}\textrm{:}\@s{3} q \.{:=} Append ( q ,\, x ) {\p@semicolon}}%
\@y{\@s{0}%
 takes effect
}%
\@xx{}%
\@x{ E3\@s{.5}\textrm{:}\@s{3} rval \.{:=}\@w{ok} {\p@semicolon}}%
\@y{\@s{0}%
...
\@x{ {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{ {\p@process} {\p@lparen} con \.{\in} consumer {\p@rparen}}%
 \@x{ {\p@variable} tmp \.{=} null ,\, rval \.{=} null {\p@semicolon}
 {\p@lbrace}}%
\@x{ D1\@s{.5}\textrm{:}\@s{3} {\p@skip} {\p@semicolon}}%
\@y{\@s{0}%
 Invocation starts, nothing to do
}%
\@xx{}%
\@x{ D2\@s{.5}\textrm{:}\@s{3} tmp \.{:=} Head ( q ) {\p@semicolon}}%
\@y{\@s{0}%
 takes effect
}%
\@xx{}%
\@x{\@s{19.76} q \.{:=} Tail ( q ) {\p@semicolon}}%
\@x{ D3\@s{.5}\textrm{:}\@s{3} rval \.{:=} tmp {\p@semicolon}}%
\@y{\@s{0}%
 invocation completes
}%
\@xx{}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{e6dc3a8f}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{9b1f9b71}'')
}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 Process variable \ensuremath{rval} of process prod at line 18 col 19 changed
 to \ensuremath{rval\_
}}%
\@xx{}%
\@x{ {\VARIABLES} pc ,\, q ,\, x ,\, rval\_ ,\, tmp ,\, rval}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} pc ,\, q ,\, x ,\, rval\_ ,\, tmp ,\, rval
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} ( producer ) \.{\cup} ( consumer )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{35.70} \.{\land} x \.{=} [ self \.{\in} producer \.{\mapsto} null ]}%
 \@x{\@s{35.70} \.{\land} rval\_ \.{=} [ self \.{\in} producer \.{\mapsto}
 null ]}%
\@x{\@s{35.70}}%
\@y{\@s{0}%
 Process con
...
\@xx{}%
 \@x{\@s{35.70} \.{\land} tmp \.{=} [ self \.{\in} consumer \.{\mapsto} null
 ]}%
 \@x{\@s{35.70} \.{\land} rval \.{=} [ self \.{\in} consumer \.{\mapsto} null
 ]}%
 \@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet \.{\mapsto} {\CASE}
 self \.{\in} producer\@s{4.47} \.{\rightarrow}\@w{E1}}%
 \@x{\@s{160.39} {\Box}\@s{10.30} self \.{\in} consumer \.{\rightarrow}\@w{D1}
 ]}%
\@pvspace{8.0pt}%
\@x{ E1 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{E1}}%
\@x{\@s{56.08} \.{\land} \E\, arg \.{\in} item \.{:}}%
\@x{\@s{75.39} x \.{'} \.{=} [ x {\EXCEPT} {\bang} [ self ] \.{=} arg ]}%
 \@x{\@s{56.08} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self
 ]\@s{0.35} \.{=}\@w{E2} ]}%
 \@x{\@s{56.08} \.{\land} {\UNCHANGED} {\langle} q ,\, rval\_ ,\, tmp ,\, rval
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ E2 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{E2}}%
\@x{\@s{56.08} \.{\land} q \.{'} \.{=} Append ( q ,\, x [ self ] )}%
 \@x{\@s{56.08} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{E3} ]}%
 \@x{\@s{56.08} \.{\land} {\UNCHANGED} {\langle} x ,\, rval\_ ,\, tmp ,\, rval
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ E3 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{E3}}%
 \@x{\@s{56.08} \.{\land} rval\_ \.{'} \.{=} [ rval\_ {\EXCEPT} {\bang} [ self
 ] \.{=}\@w{ok} ]}%
 \@x{\@s{56.08} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Done} ]}%
 \@x{\@s{56.08} \.{\land} {\UNCHANGED} {\langle} q ,\, x ,\, tmp ,\, rval
 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ prod ( self ) \.{\defeq} E1 ( self ) \.{\lor} E2 ( self ) \.{\lor} E3 (
 self )}%
\@pvspace{8.0pt}%
\@x{ D1 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{D1}}%
\@x{\@s{56.58} \.{\land} {\TRUE}}%
 \@x{\@s{56.58} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{D2} ]}%
 \@x{\@s{56.58} \.{\land} {\UNCHANGED} {\langle} q ,\, x ,\, rval\_ ,\, tmp
 ,\, rval {\rangle}}%
\@pvspace{8.0pt}%
\@x{ D2 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{D2}}%
 \@x{\@s{56.58} \.{\land} tmp \.{'} \.{=} [ tmp {\EXCEPT} {\bang} [ self ]
 \.{=} Head ( q ) ]}%
\@x{\@s{56.58} \.{\land} q \.{'} \.{=} Tail ( q )}%
 \@x{\@s{56.58} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{D3} ]}%
 \@x{\@s{56.58} \.{\land} {\UNCHANGED} {\langle} x ,\, rval\_ ,\, rval
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ D3 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{D3}}%
 \@x{\@s{56.58} \.{\land} rval \.{'} \.{=} [ rval {\EXCEPT} {\bang} [ self ]
 \.{=} tmp [ self ] ]}%
 \@x{\@s{56.58} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Done} ]}%
 \@x{\@s{56.58} \.{\land} {\UNCHANGED} {\langle} q ,\, x ,\, rval\_ ,\, tmp
 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ con ( self ) \.{\defeq} D1 ( self ) \.{\lor} D2 ( self ) \.{\lor} D3 (
 self )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} ( \E\, self \.{\in} producer \.{:} prod ( self ) )}%
\@x{\@s{47.82} \.{\lor} ( \E\, self \.{\in} consumer \.{:} con ( self ) )}%
